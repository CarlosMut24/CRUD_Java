...
public class FornecedorView extends JFrame {
    ...
    private JLabel LCodigo, LNome, LFantasia, LFisoca, LCpfCnpj, LRgIe, LCadastro,
            ...
            LCelular, LSite, LEmail, LContato, LAtivo;
    private JTextField TCodigo, TNome, TFantasia, TCpfCnpj, TRgIe, TEndereco, TNumero,
            ...
            TCelular, TSite, TEmail, TContato;
    ...
    private String colunas[] = {"Código", "Pessoa", "Contato", "Nome", "CPF/Cnpj", "Email", "Cadastro", "Ativo"};
    private FornecedorTabelaModel tabela;
    ...
    public FornecedorView() {
        ...
        setLayout(null);
        setTitle("Fornecedor"); // título do frame
    ...
    public void CriarComponentes() {
        ...
        formulario.setBorder(BorderFactory.createTitledBorder("Dados do Fornecedor"));
        ...
        consulta.setBorder(BorderFactory.createTitledBorder("Consulta de Fornecedor"));
    ...
    private void gravar() {
        if (JOptionPane.showConfirmDialog(null, "Confirma Gravação deste Cliente ?",
            ...
            try {
                FornecedorModel objusuario = new FornecedorModel();
                objusuario.setFOR_codigo(Integer.parseInt(TCodigo.getText()));
                ...
                objusuario.setFOR_contato(TContato.getText());
                objusuario.getPES_codigo().setPES_ativo((CAtivo.isSelected() ? 1 : 0));

                FornecedorController usuariocontroller = new FornecedorController();
    ...
    private void consultar() {
        ...
        if (lista.isEmpty()) {
            ...
            tabela = new FornecedorTabelaModel(lista, colunas);
    ...
    private void mostrar(FornecedorModel objModel) {
        TCodigo.setText(String.valueOf(objModel.getFOR_codigo()));
        ...
        TContato.setText(String.valueOf(objModel.getFOR_contato()));
    ...
    private void Imprimir(java.awt.event.ActionEvent evt) {
        FornecedorController objController = new FornecedorController();
